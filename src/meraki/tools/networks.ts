...
export const provisionNetworkClientsTool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      "body-policiesBySecurityAppliance": {
        type: "object",
...
export const createNetworkGroupPolicyTool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      "body-firewallAndTrafficShaping": {
        type: "object",
